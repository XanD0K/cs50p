...
# Alternatively, you can add "type hints" to the code and then run a program to check those hints (e.g. mypy)
...
## 'pip install mypy'
## mypy meows.py 
# In that code, remove/add int() converter to the input